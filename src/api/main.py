...
# ✅ NOVO: cria scaler dinâmico (fit no TREINO, sem vazamento)
...
model = None
scaler = None          # scaler salvo (treino original)
metadata = None
window_size = None
...
# ✅ ALTERADO: agora recebe scaler por parâmetro
...
def predict(req: PredictRequest):
    ...
    try:
        ...
        # ✅ NOVO: se quiser, escala dinâmica baseada no próprio history (quando /predict for usado com outro ticker)
...
def predict_yfinance(req: YFinancePredictRequest):
    ...
    try:
        ...
        # ✅ NOVO: scaler dinâmico por ticker/período (fit no treino)
        if USE_DYNAMIC_SCALER:
            n = close_values.size
            split = int(n * 0.8)
...
def backtest_yfinance(req: YFinancePredictRequest):
    ...
    try:
        ...
        # normaliza série inteira com o scaler escolhido
        ...
        # desnormaliza com o mesmo scaler escolhido
